<div class="btn-group hidden-print">
    ...
    <ul class="dropdown-menu camperdetails" role="menu" aria-labelledby="controls{{ $id }}">
        ...
        <li><a href="{{ url('/camper/' . $id) }}"><i class="fa fa-users"></i> Campers</a></li>
        <li><a href="{{ url('/payment/' . $id) }}"><i class="fa fa-usd-circle"></i> Statement</a></li>
        ...
        <li><a href="{{ url('/volunteer/' . $id) }}"><i class="fa fa-handshake"></i> Volunteer</a></li>
