...
@section('content')
    <section>
        ...
        <a href="/MUUSA_Scholarship_Process_2018.pdf" class="p-2 float-right btn btn-primary"
            ...
            <div class="col-12">
                <div class="tabs tabs-top tab-container">
                    <ul class="etabs text-center">
                        <li class="tab"><a href="#1">Main Information</a></li>
                        <li class="tab"><a href="#2">Appendix</a></li>
                        <li class="tab"><a href="#3">Examples</a></li>
                    </ul>
                    <div class="panel-container pb-5">
                        <div class="tab-content px-5" id="1"><p>Our goal at MUUSA is to make camp affordable for those
                        ...
                        <div class="tab-content px-5" id="2">
                            <h3>Appendix</h3>
                        ...
                        <div class="tab-content px-5" id="3">
