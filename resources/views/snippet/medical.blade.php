...
@include('snippet.formgroup', ['label' => 'Parent/Legal Guardian Name', 'formobject' => $camper->medicalresponse,
    'attribs' => ['name' => $camper->yearattendingid . '-parent_name']])

@include('snippet.formgroup', ['label' => 'Youth Sponsor Name (if other than above)',
    'formobject' => $camper->medicalresponse, 'attribs' => ['name' => $camper->yearattendingid . '-youth_sponsor']])

@include('snippet.formgroup', ['label' => 'Emergency Mobile Number', 'formobject' => $camper->medicalresponse,
    'attribs' => ['name' => $camper->yearattendingid . '-mobile_phone']])

@include('snippet.formgroup', ['type' => 'text', 'label' => 'Please share any medical, health, or behavioral concerns of which we should be aware. Please describe any known allergies. If your child should carry an asthma inhaler, epi-pen, or any other medical equipment or device, please make arrangements with MUUSA staff.',
    'formobject' => $camper->medicalresponse, 'attribs' => ['name' => $camper->yearattendingid . '-concerns']])

<h4>Healthcare Information</h4>

@include('snippet.formgroup', ['label' => 'Name of Doctor', 'formobject' => $camper->medicalresponse,
    'attribs' => ['name' => $camper->yearattendingid . '-doctor_name']])

@include('snippet.formgroup', ['label' => 'Phone Number of Doctor', 'formobject' => $camper->medicalresponse,
    'attribs' => ['name' => $camper->yearattendingid . '-doctor_nbr']])

@include('snippet.question', ['type' => 'select', 'name' => $camper->yearattendingid . '-is_insured',
...
>
    ...
    @include('snippet.formgroup', ['label' => 'Health Insurance Carrier Name', 'formobject' => $camper->medicalresponse,
        'attribs' => ['name' => $camper->yearattendingid . '-carrier']])

    @include('snippet.formgroup', ['label' => 'Health Insurance Carrier Phone Number',
        'formobject' => $camper->medicalresponse, 'attribs' => ['name' => $camper->yearattendingid . '-carrier_nbr']])

    @include('snippet.formgroup', ['label' => 'Health Insurance Member ID', 'formobject' => $camper->medicalresponse,
        'attribs' => ['name' => $camper->yearattendingid . '-carrier_id']])

    @include('snippet.formgroup', ['label' => 'Health Insurance Group Number', 'formobject' => $camper->medicalresponse,
