        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade active show" aria-expanded="true" id="1">
                ...
                <p>Our goal at MUUSA is to make camp affordable for those who wish to attend. We strive to accomplish
                    this goal
                    by providing lower-cost housing options, inviting campers to apply for staff positions that offer a
                    credit
                ...
                <ol>
                    <li><h6>Download an application form, available <a
                        ...
                        <p>The application form is developed by the YMCA of the Ozarks and is the same form that they
                            use to
                            evaluate scholarships for other YMCA programming. You do not have to be a YMCA member to
                            apply for a
                            MUUSA scholarship.
                        </p>
                        ...
                        <ul>
                            <li>The MUUSA Scholarship Process will follow the time schedule detailed in this document
                                (see
                                &quot;Timing&quot;), not the one outlined in the scholarship application. All
                                scholarship
                            ...
                            <li>5) Although the Trout Lodge Financial Assistance Form mentions &quot;membership&quot; in
                                several
                                places, rest assured that you are filling out the correct document for a MUUSA
                                scholarship.
                            </li>
                    ...
                    <li><h6>Submit the application by mail or e-mail by April 15 to:</h6>
                        <address>
                            Nicolle Wright<br/>
                            YMCA Trout Lodge<br/>
                    ...
                    <li><h6>Notify Maya Rao, Scholarship Committee Coordinator, once you have submitted your
                            application.</h6>
                        <p>Send
                            <a href="mailto:maya.m.rao3@gmail.com?subject=MUUSA%20Scholarship%20Application%20Submitted">Maya
                                Rao</a> an email. In the body of the email please list the names and ages (in July 2018)
                            of
                ...
                <p><strong>Scholarships are limited and cannot be guaranteed. Campers should not make any travel or
                        financial
                        plans on the assumption that they will receive a scholarship or any specific scholarship amount
                        until
                        they have received written (via email or letter) confirmation of their scholarship
                        award.</strong></p>
                <h4>Timing</h4>
                ...
                <p>Applicants who submit their applications by the April 15 deadline will be notified of their award by
                    May 15,
                    barring unforeseen delays. Balances of camper invoices on the MUUSA website will be updated as soon
                    as
                ...
                <p>If scholarship funds remain after determinations are made (by May 15), late applications (submitted
                    after
                    April 15) will be considered. These additional determinations will be made by June 10. <strong>No
                        scholarship applications submitted after June 1 will be considered.</strong></p>
                <h3>Details</h3>
                ...
                <p>Trout Lodge staff will review all applications to determine whether they meet the YMCA of the Ozarks
                    ...
                    (and
                    the amount) for the camper after MUUSA satisfies its guarantee (again, see appendix for details on
                    how this
                    works).
                </p>
                ...
                <p>Additionally, scholarships awarded will not exceed total fees after all additions and reductions
                    (including
                    staff honoraria) less $100 for each adult camper (including YAs) in Trout Lodge, Lakeview or Forest
                    View,
                    and $50 for each adult (including YAs) in Lakewood or tent camping. In other words, all adults
                    receiving
                ...
                <p>The Scholarship Committee may adjust the caps and minimum charges listed above for recipients of YMCA
                    ...
                    the
                    above amounts after exceeding its minimum guarantee to Trout Lodge. Please refer to the appendix for
                    more
                ...
                <p>Choosing to serve in a MUUSA staff role allows you to give back to the MUUSA community in a way that
                    best
                    reflects your skills and talents. Whether you choose to lead a workshop, assist in the Children's
                    Program,
                    or fill another crucial role, you are providing a valuable contribution to the MUUSA community.
                    Furthermore,
                    funding for staff honoraria is included in the MUUSA budget whereas scholarships (and their amounts)
                    are
                    subject to availability.</p>

                <h6>Thank you for your interest in applying for a scholarship for MUUSA 2018. We hope this document has
                    helped
                    clarify the scholarship process. If you have further questions or concerns please contact the
                    Scholarship
            ...
            <div role="tabpanel" class="tab-pane fade" aria-expanded="false" id="2">
                ...
                <p>MUUSA scholarships provide a discount off of the fees that MUUSA would otherwise charge a camper for
                    their
                    stay. Because MUUSA has to cover its financial obligations, the money that we are not collecting
                    from
                    campers who receive scholarships must be made up from some other source. Scholarship funds may come
                    from two
                    sources: YMCA of the Ozarks and MUUSA's own scholarship fund. Understanding how these two sources
                    work
                ...
                <p>Campers pay MUUSA for their week at camp. The revenue we receive from campers covers our fees to
                    Trout Lodge
                    (for food, lodging, Trout Lodge staff, etc.) and MUUSA expenses (for program staff, supplies,
                    insurance,
                    etc.). Our contract with Trout Lodge obligates MUUSA to pay a certain minimum guaranteed amount to
                    Trout
                    Lodge (the &quot;minimum guarantee&quot;), regardless of how many campers register or our actual
                    revenue.
                    Paying the minimum guarantee allows MUUSA to retain exclusive rights to the Trout Lodge property.We
                    have not
                    met the minimum guaranteein some years, or met it by only a very small margin, even though camp has
                    been
                    nearly full. This is because Trout Lodge bases the minimum guarantee on a higher occupancy rate
                    (i.e., more
                ...
                <p>The YMCA of the Ozarks has funding to provide a limited number of scholarships to MUUSA campers who
                    may not
                    otherwise be able to afford a camp experience. These scholarships do not go directly to the camper
                    or MUUSA.
                    Rather, they operate as a percentage discount off of what Trout Lodge would otherwise charge MUUSA
                    for that
                    camper's stay. However, the YMCA provides these discounts only once MUUSA's minimum guarantee is
                    met. In
                    other words, YMCA scholarships only benefit MUUSA campers to the extent that our enrollment is high
                    enough
                    to exceed our minimum guarantee with Trout Lodge. Even if we exceed the guarantee by more than the
                    value of
                    the scholarships awarded, YMCA scholarships do not cover the other MUUSA expenses paid for by our
                    camp fees.
                </p>

                <p>MUUSA has its own scholarship fund that we use to provide additional assistance with camp costs not
                    covered
                    by YMCA scholarships. These funds come mainly from voluntary donations from MUUSA campers and
                    through
                ...
                <p>Each year, the Treasurer and Registrar will review the balance in the Scholarship Fund as well as
                    MUUSA's
                    projected enrollment and revenue. They will then recommend an amount to be included in the budget
                    for
                    scholarship awards. The amount available for distribution will be included in the budget approved by
                    the
            ...
            <div role="tabpanel" class="tab-pane fade" aria-expanded="false" id="3">
                ...
                <h4>Example3:</h4>
                <p>
                    2 adults staying in a Forest View cabin with 1 adult leading a 5 day workshop. The Scholarship
                    Committee
